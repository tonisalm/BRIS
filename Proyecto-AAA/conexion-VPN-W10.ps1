...
#
#-ServerAddress: Es la ip externa del NAS o cliente Radius
...
#
Add-VpnConnection -Name "VPN-JaumeI" -ServerAddress "192.168.2.63" -TunnelType PPTP -AuthenticationMethod MSChapv2 -RememberCredential
